...
+ Request
        ...
        {
            //建议前端默认都设为all
            "is_free": "是否有酬" ,//0代表有酬，1代表无酬 //all表示所有
...
[获取所有求助](#GetAllQuestion) `GET {base_url}/api/getAllQuestions`
...
### 获取所有求助  `GET {base_url}/api/getAllQuestions`
