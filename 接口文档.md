...
[提交认证图片](#certification) `POST {base_url}/api/user/certification`  

//admin审核

[获取待审核成员](#adminGetCertification) `GET {base_url}/api/admin/user/certification`  

[管理员审核成员](#adminAuditCert) `PUT {base_url}/api/admin/user/certification/:user_id`  
...
### 提交认证图片  `POST {base_url}/api/user/certification` 
...
<a name="adminGetCertification"></a>
<span id="adminGetCertification"></span>

### 获取待审核成员 `GET {base_url}/api/admin/user/certification`  
...
+ Response 200
                ...
                "data": [
                        ...
                        "wechat_id": 111,
                        "photo": null,
                        "update_time": "2019-05-08 17:50:10",
                        "create_time": "2019-04-20 15:23:10",
                        "delete_time": "0000-00-00 00:00:00",
                        "role": "2",
                        "new_message": "1",
                        ...
                        "score": 9,
                        "help_num": 2,
                        "cert_photo": "20190508/ab37fdcd68f84334d9c8f01dd03b1fb4.jpg"
                        }
                        ...
                ]
                }
...
<a name="adminAuditCert"></a>
<span id="adminAuditCert"></span>

### 管理员审核成员 `PUT {base_url}/api/admin/user/certification/:user_id` 
...
[求助增加图片](#addHelpPicture) `POST {base_url}/api/addHelpPicture/:help_id`
...
<a name="addHelpPicture"></a>
<span id="addHelpPicture"></span>

### 求助增加图片 `POST {base_url}/api/addHelpPicture/:help_id`
...
[提问增加图片](#addQuestionPicture) `POST {base_url}/api/addQuestionPicture/:help_id`
...
<a name="addQuestionPicture"></a>
<span id="addQuestionPicture"></span>

### 提问增加图片 `POST {base_url}/api/addQusetionPicture/:help_id`
