...
[获取本人所有求助](#getCurrentAllhelpComment) `GET {base_url}/api/help_comments/:help_id`

[获取某个求助](#getOnehelpComment) `GET {base_url}/api/help_comment/:help_comment_id`

[新增求助](#createhelpComment) `POST {base_url}/api/help_comment`

[删除某个求助](#deletehelpComment) `DELETE {base_url}/api/help_comment/:help_comment_id` 
...
### 获取本人所有求助 `GET {base_url}/api/help_comments/:help_id`
...
### 获取某个求助 `GET {base_url}/api/help_comment/:help_comment_id`
...
### 新增求助 `POST {base_url}/api/help_comment`
...
### 删除求助 `DELETE {base_url}/api/help_comment/:help_comment_id`
